                  ...
                  <div className="flex-1">
                    ...
                    {book.link ? (
                      <a href={book.link} target="_blank" rel="noopener noreferrer">
                        <button className="mt-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 px-4 py-2 rounded-xl transition-all duration-300 shadow-lg hover:shadow-[0_0_20px_rgba(236,72,153,0.5)] text-sm font-medium flex items-center gap-2">
